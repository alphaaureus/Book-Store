...
const CreateBook = () => {
	...
	const handleSaveBook = () => {
		...
		axios
			...
			.catch((error) => {
				setLoading(false);
				enqueueSnackbar('An error happened when creating this book.', { variant: 'error' });
				console.log(error);
			})
	};
	...
	return (
		<div className='p-4'>
			...
			{loading ? <Spinner /> : ''}
			<div className='flex flex-col border-2 border-sky-400 rounded-x1 w-fit p-4 mx-auto'>
				<div className='my-4'>
